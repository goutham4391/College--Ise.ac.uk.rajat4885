...
function url() {
  var alias = "else";
  var project = "executiveeducation";
  var projectAndAlias =
...
context.DELIVERY_API_CONFIG = Object({
  ...
  projectId: "executiveeducation",
  livePublishingRootUrl: url().previewWeb,
});

context.PROJECTS = Object([{"id":"executiveeducation","publicUri":"lse.ac.uk"}]);

context.ALIAS = "else";
context.ACCESS_TOKEN = "gnIlDXEa99dkods6o6PZfZ3vAVrBqeUecgrywqZ00SUDwRi7";
context.PUBLIC_URL = "lse.ac.uk";
context.PROJECT = "executiveeducation";
context.CONTENSIS_VERSION = "12";
context.STATIC_ROUTE_PATH = "static-lse-executive-education";
